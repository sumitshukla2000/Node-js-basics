...
router.get('/' , (req,res,next)=>{
    ...
    res.render('shop' , {prods : products , docTitle : 'My Shop'} ); //this will point to the shop.pug file to render the dyanamic content ,,second argument should be passed in js object
